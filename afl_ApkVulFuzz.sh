...
AFL_FAST_CAL=1 AFL_IGNORE_PROBLEMS=1 AFL_I_DONT_CARE_ABOUT_MISSING_CRASHES=1 \
AFL_SKIP_CPUFREQ=1 AFL_NO_AFFINITY=1 AFL_DUMB_FORKSRV=1 AFL_SKIP_BIN_CHECK=1 \
